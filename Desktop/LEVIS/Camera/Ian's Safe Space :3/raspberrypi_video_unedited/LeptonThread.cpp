...
#include <iostream>
#include </home/pi/opencv-4.0.0/build/opencv2/opencv_modules.hpp>
...
{
	//
	//loglevel = 0;sudo apt-get install libopencv-devpython-opencv
...
void LeptonThread::snapImage() {
  ...
  bigger.save("/home/pi/Desktop/LEVIS/Camera/Thermal/testFacial.png");
  QLabel *popup = new QLabel();
  QPixmap pixmap = QPixmap::fromImage(bigger);
  popup->setPixmap(pixmap);
  popup->show();
  system("cd /home/pi/thermal-facial-landmarks-detection")
  system("python dlib_predict_image.py --images /home/pi/Desktop/LEVIS/Camera/Thermal/testFacial.png --models  models/ --upsample 1")
}
